...
const BalanceTransfer = () => {
  return (
    <div className="text-[#616161] mb-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] pb-10">
      ...
      <div className=" mt-5 flex justify-center">
        <button className=" btn btn-primary btn-sm text-white flex items-center ">
          <BsFillCreditCardFill className="text-2xl" /> <span> Transfer</span>
        </button>
      </div>
    </div>
  )
